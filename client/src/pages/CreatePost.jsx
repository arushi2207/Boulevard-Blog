        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-4 sm:flex-row justify-between">
                ...
                <Select onChange={(e)=>setFormData({...formData, category: e.target.value })}>
                    ...
                    <option value='cooking'>Food and Cooking</option>
                    <option value='finance'>Personal Finance and Money Management</option>
                </Select>
            </div>
            <div className="flex gap-4 items-center justify-between border-4 border-teal-500 border-dotted p-3">
                <FileInput type='file' accept='image/*' onChange={(e) => setFile(e.target.files[0])} />
                <Button type='button' gradientDuoTone='prupleToPink' size='sm' outline onClick={handleUploadImage} disabled={imageUploadProgress}>
                    {imageUploadProgress ? (
